...
class StraightFlushValidatorTest(unittest.TestCase):
    def test_validates_that_there_are_not_five_consecutive_cards_with_the_same_suits(self):
        cards = [
    ...
    def test_validates_that_there_are_five_consecutive_cards_with_the_same_suits(self):
        cards = [
            Card(rank = "3", suit = "Clubs"),
            Card(rank = "4", suit = "Clubs"),
            Card(rank = "5", suit = "Clubs"),
